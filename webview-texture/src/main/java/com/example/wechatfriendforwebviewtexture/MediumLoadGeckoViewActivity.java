...
/**
 * 中负载 GeckoView SurfaceTexture版朋友圈Activity
 */
public class MediumLoadGeckoViewActivity extends BaseGeckoViewTextureActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("GeckoView SurfaceTexture朋友圈 - 帧内中负载");
        Trace.endSection();
    }
