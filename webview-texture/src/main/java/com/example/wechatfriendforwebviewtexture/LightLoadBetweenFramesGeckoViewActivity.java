...
/**
 * 帧间轻负载 GeckoView SurfaceTexture版朋友圈Activity
 */
public class LightLoadBetweenFramesGeckoViewActivity extends BaseGeckoViewTextureActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("GeckoView SurfaceTexture朋友圈 - 帧间轻负载");
        Trace.endSection();
    }
