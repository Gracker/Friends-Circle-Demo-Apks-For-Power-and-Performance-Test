...
/**
 * 重负载 GeckoView SurfaceTexture版朋友圈Activity
 */
public class HeavyLoadGeckoViewActivity extends BaseGeckoViewTextureActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("GeckoView SurfaceTexture朋友圈 - 帧内高负载");
        Trace.endSection();
    }
