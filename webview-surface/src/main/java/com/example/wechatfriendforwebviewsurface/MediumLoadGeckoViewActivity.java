...
/**
 * 中负载 GeckoView SurfaceView版朋友圈Activity
 */
public class MediumLoadGeckoViewActivity extends BaseGeckoViewSurfaceActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("GeckoView SurfaceView朋友圈 - 帧内中负载");
        Trace.endSection();
    }
