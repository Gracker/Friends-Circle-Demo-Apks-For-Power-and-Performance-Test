...
/**
 * 帧间中负载 GeckoView SurfaceView版朋友圈Activity
 */
public class MediumLoadBetweenFramesGeckoViewActivity extends BaseGeckoViewSurfaceActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("GeckoView SurfaceView朋友圈 - 帧间中负载");
        Trace.endSection();
    }
