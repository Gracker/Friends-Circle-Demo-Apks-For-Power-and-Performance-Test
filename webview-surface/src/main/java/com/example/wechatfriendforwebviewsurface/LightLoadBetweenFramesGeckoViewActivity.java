...
/**
 * 帧间轻负载 GeckoView SurfaceView版朋友圈Activity
 */
public class LightLoadBetweenFramesGeckoViewActivity extends BaseGeckoViewSurfaceActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("GeckoView SurfaceView朋友圈 - 帧间轻负载");
        Trace.endSection();
    }
