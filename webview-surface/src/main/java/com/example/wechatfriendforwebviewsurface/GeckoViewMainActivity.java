...
/**
 * GeckoView SurfaceView版朋友圈主界面
 * 提供选择不同负载级别的入口，用于性能测试对比
 * 
 * 渲染模式：SurfaceView
 * - GeckoView 渲染内容直接输出到 SurfaceView 的 Surface
 * - 独立 Surface 直接提交到 SurfaceFlinger
 * - 不经过 App 的 UI Thread + RenderThread 合成
 */
public class GeckoViewMainActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "初始化GeckoView SurfaceView版朋友圈测试主界面");
    ...
    public void onClick(View v) {
        ...
        if (intent != null) {
            ...
            Log.d(TAG, "启动" + loadName + "GeckoView SurfaceView版朋友圈");
