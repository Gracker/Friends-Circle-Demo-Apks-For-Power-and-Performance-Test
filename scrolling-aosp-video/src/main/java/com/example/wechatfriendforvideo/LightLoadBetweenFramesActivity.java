...
public class LightLoadBetweenFramesActivity extends AppCompatActivity implements Choreographer.FrameCallback {
    ...
    private static final String TAG = "LightBetweenFrames";
    ...
    private float mTaskExecutionProbability = LoadConfig.LIGHT_TASK_PROBABILITY;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null && intent.hasExtra(VideoMainActivity.EXTRA_LOAD_TYPE)) {
            mLoadType = intent.getIntExtra(VideoMainActivity.EXTRA_LOAD_TYPE, LoadType.LIGHT_BETWEEN_FRAMES);
        }
