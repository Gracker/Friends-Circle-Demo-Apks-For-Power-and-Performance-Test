package com.example.wechatfriendforsoftwarerender.beans;
...
public class CommentBean {
    ...
    public void build() {
        ...
        if (TextUtils.isEmpty(parentUserName)) {
            // 普通评论
            commentContentSpan = SoftwareRenderSpanUtils.makeSingleCommentSpan(
                    mContext, childUserName, commentContent);
        } else {
            // 回复评论
            commentContentSpan = SoftwareRenderSpanUtils.makeReplyCommentSpan(
