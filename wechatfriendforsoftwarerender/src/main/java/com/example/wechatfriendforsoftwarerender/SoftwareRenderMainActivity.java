...
public class SoftwareRenderMainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void startMinimalLoadActivity() {
        ...
        intent.putExtra(EXTRA_LOAD_TYPE, SoftwareRenderFriendCircleAdapter.LOAD_TYPE_MINIMAL);
    ...
    private void startLightLoadActivity() {
        ...
        intent.putExtra(EXTRA_LOAD_TYPE, SoftwareRenderFriendCircleAdapter.LOAD_TYPE_LIGHT);
        startActivity(intent);
        finish();
    }
    ...
    private void startMediumLoadActivity() {
        ...
        intent.putExtra(EXTRA_LOAD_TYPE, SoftwareRenderFriendCircleAdapter.LOAD_TYPE_MEDIUM);
        startActivity(intent);
        finish();
    }
    ...
    private void startHeavyLoadActivity() {
        ...
        intent.putExtra(EXTRA_LOAD_TYPE, SoftwareRenderFriendCircleAdapter.LOAD_TYPE_HEAVY);
        startActivity(intent);
        finish();
    }
