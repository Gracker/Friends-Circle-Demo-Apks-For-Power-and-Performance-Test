...
declare -a MODULE_CONFIG=(
    "app|app-release|主应用"
    "scrolling-aosp-performance|scrolling-aosp-performance-release|滑动性能测试"
    "scrolling-aosp-power|scrolling-aosp-power-release|滑动电量测试"
    "scrolling-aosp-picasso|scrolling-aosp-picasso-release|滑动-Picasso"
    "scrolling-aosp-customscroller|scrolling-aosp-customscroller-release|滑动自定义滚动"
    "scrolling-aosp-renderstress|scrolling-aosp-renderstress-release|滑动渲染压测"
    "scrolling-aosp-softwarerender|scrolling-aosp-softwarerender-release|滑动软件渲染"
    "scrolling-aosp-douyin|scrolling-aosp-douyin-release|滑动抖音版本"
    "scrolling-aosp-video|scrolling-aosp-video-release|滑动视频版本"
    "scrolling-aosp-ebook|scrolling-aosp-ebook-release|滑动电子书"
    "scrolling-aosp-purerenderthread|scrolling-aosp-purerenderthread-release|滑动纯渲染线程"
    "scrolling-aosp-dualwindow|scrolling-aosp-dualwindow-release|滑动双窗口"
    "scrolling-aosp-mixedrender|scrolling-aosp-mixedrender-release|滑动混合渲染"
    "scrolling-compose|scrolling-compose-release|滑动Compose版本"
    "scrolling-webview|scrolling-webview-release|滑动WebView版本"
    "scrolling-webview-surface|scrolling-webview-surface-release|滑动WebView-Surface"
    "scrolling-webview-texture|scrolling-webview-texture-release|滑动WebView-Texture"
    "scrolling-webview-imagereader|scrolling-webview-imagereader-release|滑动WebView-ImageReader"
    "scrolling-surface-map|scrolling-surface-map-release|滑动Surface地图"
    "scrolling-gl-map|scrolling-gl-map-release|滑动GL地图"
