...
/**
 * Minimal Load Activity, completely no extra load, the lightest case
 */
public class MinimalLoadActivity extends AppCompatActivity {

    private static final String TAG = "MinimalLoadActivity";
    private RecyclerView recyclerView;
    private VideoFriendCircleAdapter adapter;
    private RequestBuilder<Drawable> imageLoader;
    private int mLoadType = VideoFriendCircleAdapter.LOAD_TYPE_MINIMAL;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null && intent.hasExtra(VideoMainActivity.EXTRA_LOAD_TYPE)) {
            mLoadType = intent.getIntExtra(VideoMainActivity.EXTRA_LOAD_TYPE, VideoFriendCircleAdapter.LOAD_TYPE_MINIMAL);
        }
    ...
    private String getLoadTypeString(int loadType) {
        switch (loadType) {
            case VideoFriendCircleAdapter.LOAD_TYPE_MINIMAL:
                return "最轻负载";
