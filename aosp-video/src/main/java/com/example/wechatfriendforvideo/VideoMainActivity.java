...
public class VideoMainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        Trace.beginSection("VideoMainActivity_onCreate");
     ...
     * 
     * 使用方法：
     * adb shell am start -n com.example.wechatfriendforvideo/.VideoMainActivity --es activity_type minimal
     * adb shell am start -n com.example.wechatfriendforvideo/.VideoMainActivity --es activity_type light
     * adb shell am start -n com.example.wechatfriendforvideo/.VideoMainActivity --es activity_type medium
     * adb shell am start -n com.example.wechatfriendforvideo/.VideoMainActivity --es activity_type heavy
     * adb shell am start -n com.example.wechatfriendforvideo/.VideoMainActivity --es activity_type light_between_frames
     * adb shell am start -n com.example.wechatfriendforvideo/.VideoMainActivity --es activity_type medium_between_frames
     * adb shell am start -n com.example.wechatfriendforvideo/.VideoMainActivity --es activity_type heavy_between_frames
     * adb shell am start -n com.example.wechatfriendforvideo/.VideoMainActivity --es activity_type light_mixed
     * adb shell am start -n com.example.wechatfriendforvideo/.VideoMainActivity --es activity_type medium_mixed
     * adb shell am start -n com.example.wechatfriendforvideo/.VideoMainActivity --es activity_type heavy_mixed
     */
    ...
    protected void onResume() {
        Trace.beginSection("VideoMainActivity_onResume");
        super.onResume();
        // 确保数据中心的缓存被清空
        VideoDataCenter.getInstance().clearCachedData();
        Trace.endSection();
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.btn_minimal_load) {
            ...
            Trace.beginSection("VideoMainActivity_startLightLoad");
            ...
            Trace.beginSection("VideoMainActivity_startMediumLoad");
            ...
            Trace.beginSection("VideoMainActivity_startHeavyLoad");
            ...
            Trace.beginSection("VideoMainActivity_startLightLoadBetweenFrames");
            ...
            Trace.beginSection("VideoMainActivity_startMediumLoadBetweenFrames");
            ...
            Trace.beginSection("VideoMainActivity_startHeavyLoadBetweenFrames");
            ...
            Trace.beginSection("VideoMainActivity_startLightMixedLoad");
            ...
            Trace.beginSection("VideoMainActivity_startMediumMixedLoad");
            ...
            Trace.beginSection("VideoMainActivity_startHeavyMixedLoad");
