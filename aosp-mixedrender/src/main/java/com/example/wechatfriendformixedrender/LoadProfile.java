...
/**
 * Defines 10 load profiles for mixed rendering test.
 * This demo combines:
 * - Pure RenderThread animation (SurfaceView with dedicated render thread)
 * - Normal UI + RenderThread rendering (RecyclerView with standard View hierarchy)
 */
