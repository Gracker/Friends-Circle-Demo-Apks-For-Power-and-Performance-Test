...
/**
 * 轻负载 GeckoView SurfaceView版朋友圈Activity
 * 帧内轻负载实现
 */
public class LightLoadGeckoViewActivity extends BaseGeckoViewSurfaceActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("GeckoView SurfaceView朋友圈 - 帧内轻负载");
        Trace.endSection();
    }
