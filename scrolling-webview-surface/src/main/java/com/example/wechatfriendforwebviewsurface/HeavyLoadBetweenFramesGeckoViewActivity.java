...
/**
 * 帧间高负载 GeckoView SurfaceView版朋友圈Activity
 */
public class HeavyLoadBetweenFramesGeckoViewActivity extends BaseGeckoViewSurfaceActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("GeckoView SurfaceView朋友圈 - 帧间高负载");
        Trace.endSection();
    }
