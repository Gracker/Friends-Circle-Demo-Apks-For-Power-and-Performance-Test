...
public class PerformanceMainActivity extends AppCompatActivity implements View.OnClickListener {
     ...
     * 
     * 使用方法：
     * adb shell am start -n com.example.wechatfriendforpicasso/.PerformanceMainActivity --es activity_type minimal
     * adb shell am start -n com.example.wechatfriendforpicasso/.PerformanceMainActivity --es activity_type light
     * adb shell am start -n com.example.wechatfriendforpicasso/.PerformanceMainActivity --es activity_type medium
     * adb shell am start -n com.example.wechatfriendforpicasso/.PerformanceMainActivity --es activity_type heavy
     * adb shell am start -n com.example.wechatfriendforpicasso/.PerformanceMainActivity --es activity_type light_between_frames
     * adb shell am start -n com.example.wechatfriendforpicasso/.PerformanceMainActivity --es activity_type medium_between_frames
     * adb shell am start -n com.example.wechatfriendforpicasso/.PerformanceMainActivity --es activity_type heavy_between_frames
     * adb shell am start -n com.example.wechatfriendforpicasso/.PerformanceMainActivity --es activity_type light_mixed
     * adb shell am start -n com.example.wechatfriendforpicasso/.PerformanceMainActivity --es activity_type medium_mixed
     * adb shell am start -n com.example.wechatfriendforpicasso/.PerformanceMainActivity --es activity_type heavy_mixed
     */
            ...
            if (activityType != null) {
                ...
                switch (activityType) {
                    ...
                    case ACTIVITY_TYPE_HEAVY_MIXED:
                        ...
                        break;
                    default:
                        Log.w("PerformanceMainActivity", "Unknown activity_type: " + activityType);
                        break;
                }
            }
        }
    ...
    private void startMinimalLoadActivity() {
        ...
        intent.putExtra(EXTRA_LOAD_TYPE, PerformanceFriendCircleAdapter.LOAD_TYPE_MINIMAL);
