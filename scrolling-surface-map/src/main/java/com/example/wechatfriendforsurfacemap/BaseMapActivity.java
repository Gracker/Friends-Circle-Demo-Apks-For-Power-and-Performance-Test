...
public abstract class BaseMapActivity extends AppCompatActivity {
    ...
    private void setupBottomControls() {
        findViewById(R.id.btn_zoom_in).setOnClickListener(v -> showFeaturePending());
        findViewById(R.id.btn_zoom_out).setOnClickListener(v -> showFeaturePending());
        findViewById(R.id.btn_location).setOnClickListener(v -> showFeaturePending());
        findViewById(R.id.btn_layers).setOnClickListener(v -> showFeaturePending());
    }

    private void showFeaturePending() {
