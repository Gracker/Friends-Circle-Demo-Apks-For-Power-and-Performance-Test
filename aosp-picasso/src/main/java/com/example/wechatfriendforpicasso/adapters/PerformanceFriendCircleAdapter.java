package com.example.wechatfriendforpicasso.adapters;
...
import com.example.wechatfriendforpicasso.PerformanceConstants;
...
import com.example.wechatfriendforpicasso.interfaces.OnItemClickPopupMenuListener;
import com.example.wechatfriendforpicasso.interfaces.OnPraiseOrCommentClickListener;
import com.example.wechatfriendforpicasso.utils.PerformanceSpanUtils;
import com.example.wechatfriendforpicasso.utils.RoundedCornersTransformation;
...
public class PerformanceFriendCircleAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> 
    ...
    private RoundedCornersTransformation mRoundedTransformation;
    ...
    public PerformanceFriendCircleAdapter(Context context, RecyclerView recyclerView, int loadType) {
        ...
        // 使用RoundedCorners变换，增大圆角半径为30dp
        this.mRoundedTransformation = new RoundedCornersTransformation(dpToPx(30));
