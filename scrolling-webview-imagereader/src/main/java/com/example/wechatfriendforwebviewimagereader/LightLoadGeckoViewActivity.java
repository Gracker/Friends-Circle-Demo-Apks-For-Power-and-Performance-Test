...
/**
 * 轻负载 GeckoView ImageReader版朋友圈Activity
 * 帧内轻负载实现
 */
public class LightLoadGeckoViewActivity extends BaseGeckoViewImageReaderActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("GeckoView ImageReader朋友圈 - 帧内轻负载");
        Trace.endSection();
    }
