package com.example.wechatfriendfordualwindow.adapters;
 ...
 */
public class DualWindowFriendCircleAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> 
    ...
    public DualWindowFriendCircleAdapter(Context context, RecyclerView recyclerView, int loadType) {
