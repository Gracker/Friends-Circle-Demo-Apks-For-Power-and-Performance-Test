...
import static com.example.wechatfriendfordualwindow.DualWindowConstants.*;

/**
 * DualWindow test data center, generate fixed test data
 */
public class DualWindowDataCenter {

    private static final String TAG = "DualWindowDataCenter";
    private static final int FRIEND_CIRCLE_COUNT = 100; // 固定生成100条朋友圈数据

    private static final DualWindowDataCenter instance = new DualWindowDataCenter();
