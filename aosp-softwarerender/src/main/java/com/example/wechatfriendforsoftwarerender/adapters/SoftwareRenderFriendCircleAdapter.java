package com.example.wechatfriendforsoftwarerender.adapters;
...
import com.example.wechatfriendforsoftwarerender.SoftwareRenderConstants;
import com.example.wechatfriendforsoftwarerender.R;
...
import com.example.wechatfriendforsoftwarerender.interfaces.OnItemClickPopupMenuListener;
import com.example.wechatfriendforsoftwarerender.interfaces.OnPraiseOrCommentClickListener;
import com.example.wechatfriendforsoftwarerender.utils.SoftwareRenderSpanUtils;
import com.example.wechatfriendforsoftwarerender.widgets.NineGridView;
 ...
 */
public class SoftwareRenderFriendCircleAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> 
    ...
    public SoftwareRenderFriendCircleAdapter(Context context, RecyclerView recyclerView, int loadType) {
        ...
        mFrameLoadRunnable = new Runnable() {
            ...
            public void run() {
                if (mIsScrolling) {
                    mLoadSimulator.executeInFrameLoad(mLoadType, "SoftwareRenderAdapter_continuousLoad");
        ...
        if (hasPraise || hasComment) {
            ...
            if (hasPraise) {
                ...
                if (friendCircleBean.getPraiseSpan() == null) {
                    SpannableStringBuilder praiseSpan = SoftwareRenderSpanUtils.makePraiseSpan(
