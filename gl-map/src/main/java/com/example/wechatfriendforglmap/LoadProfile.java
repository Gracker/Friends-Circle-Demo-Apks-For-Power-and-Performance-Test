...
/**
 * Defines 10 load profiles for OpenGL map rendering test.
 * This demo uses GLSurfaceView to render a map-like interface,
 * simulating apps like Google Maps or Amap.
 */
