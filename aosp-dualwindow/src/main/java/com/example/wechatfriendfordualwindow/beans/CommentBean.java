package com.example.wechatfriendfordualwindow.beans;
...
public class CommentBean {
    ...
    public void build() {
        ...
        if (TextUtils.isEmpty(parentUserName)) {
            // 普通评论
            commentContentSpan = DualWindowSpanUtils.makeSingleCommentSpan(
                    mContext, childUserName, commentContent);
        } else {
            // 回复评论
            commentContentSpan = DualWindowSpanUtils.makeReplyCommentSpan(
