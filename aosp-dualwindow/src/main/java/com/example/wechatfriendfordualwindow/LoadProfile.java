...
/**
 * Defines 10 load profiles for dual window rendering test.
 * This demo creates two windows that render simultaneously,
 * resulting in 2 doFrame + 2 RenderThread drawFrame per vsync.
 */
