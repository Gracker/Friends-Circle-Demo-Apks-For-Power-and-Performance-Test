package com.example.wechatfriendforcustomscroller.beans;
...
public class CommentBean {
    ...
    private transient CharSequence commentContentSpan;
    ...
    public CharSequence getCommentContentSpan() {
    ...
    public void setCommentContentSpan(CharSequence commentContentSpan) {
    ...
    public void build() {
        ...
        if (mContext == null) {
            ...
            commentContentSpan = TextUtils.isEmpty(childUserName)
                    ? "用户"
                    : childUserName;
            return;
        }
        ...
        if (TextUtils.isEmpty(parentUserName)) {
            // 普通评论
            builder = PerformanceSpanUtils.makeSingleCommentSpan(
                    mContext, childUserName, commentContent);
        } else {
            // 回复评论
            builder = PerformanceSpanUtils.makeReplyCommentSpan(
                    mContext, childUserName, parentUserName, commentContent);
        }
        commentContentSpan = new SpannedString(builder);
    }
