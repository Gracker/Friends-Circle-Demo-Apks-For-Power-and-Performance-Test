...
/**
 * 重负载 GeckoView ImageReader版朋友圈Activity
 */
public class HeavyLoadGeckoViewActivity extends BaseGeckoViewImageReaderActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("GeckoView ImageReader朋友圈 - 帧内高负载");
        Trace.endSection();
    }
