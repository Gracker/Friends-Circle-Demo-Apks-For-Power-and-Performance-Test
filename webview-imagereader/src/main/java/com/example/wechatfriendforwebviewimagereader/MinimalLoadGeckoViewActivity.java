...
/**
 * 最轻负载 GeckoView ImageReader版朋友圈Activity
 * 不添加任何额外负载
 */
public class MinimalLoadGeckoViewActivity extends BaseGeckoViewImageReaderActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("GeckoView ImageReader朋友圈 - 最轻负载");
        Trace.endSection();
    }
