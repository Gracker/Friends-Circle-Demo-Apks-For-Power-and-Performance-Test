...
/**
 * 混合轻负载 GeckoView ImageReader版朋友圈Activity
 */
public class LightMixedLoadGeckoViewActivity extends BaseGeckoViewImageReaderActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("GeckoView ImageReader朋友圈 - 混合轻负载");
        Trace.endSection();
    }
